...
@Component({
  selector: 'app-gorsel-danismanlik',
  standalone: true,
  imports: [HeroComponent, CommonModule, TranslatePipe, ServicesSliderComponent, SidebarContactComponent],
  templateUrl: './gorsel-danismanlik.component.html',
  styleUrls: ['./gorsel-danismanlik.component.scss']
})
export class GorselDanismanlikComponent {
