...
@Component({
  selector: 'app-koleksiyon-tasarim',
  standalone: true,
  imports: [HeroComponent, CommonModule, TranslatePipe, ServicesSliderComponent, SidebarContactComponent],
  templateUrl: './koleksiyon-tasarim.component.html',
  styleUrls: ['./koleksiyon-tasarim.component.scss']
})
export class KoleksiyonTasarimComponent {
